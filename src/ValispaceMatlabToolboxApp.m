classdef ValispaceMatlabToolboxApp < handle
    %
    % Usage:
    %     app.ValispaceMatlabToolboxApp
    ...
    properties (Constant)
        AppPathBase = {'/ValispaceMatlabToolbox'};
        AppClass = 'ValispaceMatlabToolboxApp';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function obj = ValispaceMatlabToolboxApp()
        ...
        function startApp(obj)
            ...
            mlock;
            ValispaceMatlabToolboxApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'ValispaceMain')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong ValispaceMain
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'ValispaceMain').getString, ...
            ...
            if nargout(@ValispaceMain) == 0
                eval('ValispaceMain');
            else
                obj.AppHandle = eval('ValispaceMain');
            end
